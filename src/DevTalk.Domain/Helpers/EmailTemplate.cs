...
";
    ...
    public static string PasswordResetEmailLink(string Url)
    {
        return $@"
<!DOCTYPE html>
<html>
    <head>
        <meta charset='utf-8' />
        <meta http-equiv='x-ua-compatible' content='ie=edge' />
        <title>Password Reset - DevTalk</title>
        <meta name='viewport' content='width=device-width, initial-scale=1' />
        <style>
            @media screen {{
                @font-face {{
        ...
        <div class='email-wrapper'>
            <div class='email-container'>
                ...
                <div class='email-body'>
                    ...
                    <p>
                        We received a request to reset your password for your <strong>DevTalk</strong> account. Click the button below to reset it.
                    </p>
                    <div class='email-button'>
