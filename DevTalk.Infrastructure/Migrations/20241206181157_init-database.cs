    ...
    public partial class initdatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PostMediaId = table.Column<string>(type: "nvarchar(450)", nullable: false, defaultValueSql: "newid()"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    VoteId = table.Column<string>(type: "nvarchar(450)", nullable: false, defaultValueSql: "newid()"),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    CommentId = table.Column<string>(type: "nvarchar(450)", nullable: false, defaultValueSql: "newid()"),
                    VoteId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    VoteType = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommentVotes", x => x.CommentId);
                    table.ForeignKey(
